...
import { BudgetOptimizationSkeleton } from './BudgetOptimizationSkeleton';

// Lazy load the main component
const BudgetOptimizationContent = React.lazy(() => import('./BudgetOptimizationContent'));
...
const BudgetOptimizationDashboard: React.FC = () => {
  ...
  return (
    <Suspense fallback={<BudgetOptimizationSkeleton />}>
